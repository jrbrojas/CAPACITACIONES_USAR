...
export class NavService implements OnDestroy {
  ...
  MENU_ITEMS: Menu[] = [
    ...
    {
      title: 'CONSULTA', tooltip: 'CONSULTA', icon: 'shield', type: 'sub', active: false, children: [
    ...
    },
    {
      title: 'SEGURIDAD', tooltip: 'Seguridad', icon: 'folder-plus', type: 'sub', active: false, children: [
        { path: '/capacitaciones/seguridad/usuarios', title: 'Usuarios', type: 'link' },
        { path: '/capacitaciones/seguridad/perfiles', title: 'Perfiles', type: 'link' },
        { path: '/capacitaciones/seguridad/permisos', title: 'Permisos', type: 'link' },
        { path: '/capacitaciones/seguridad/solicitud-list', title: 'Solicitud de credenciales', type: 'link' },
      ]
    },
